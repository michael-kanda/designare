...
async function fetchPageSpeedInsights(url) {
  try {
    const apiUrl = `${PAGESPEED_API}?url=${encodeURIComponent(url)}&category=performance&category=seo&category=accessibility&category=best-practices&strategy=mobile`;
